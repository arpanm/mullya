...
class RequirementResourceIT {
    ...
    void createRequirement() throws Exception {
        ...
        assertThat(testRequirement.getAcceptedPrice()).isEqualTo(DEFAULT_ACCEPTED_PRICE);
        assertThat(testRequirement.getCodAmount()).isEqualTo(DEFAULT_COD_AMOUNT);
        ...
        assertThat(testRequirement.getPaymentDate()).isEqualTo(DEFAULT_PAYMENT_DATE);
        assertThat(testRequirement.getAcceptedDeliveryDate()).isEqualTo(DEFAULT_ACCEPTED_DELIVERY_DATE);
    ...
    void putNewRequirement() throws Exception {
        ...
        assertThat(testRequirement.getAcceptedPrice()).isEqualTo(UPDATED_ACCEPTED_PRICE);
        assertThat(testRequirement.getCodAmount()).isEqualTo(UPDATED_COD_AMOUNT);
        ...
        assertThat(testRequirement.getPaymentDate()).isEqualTo(UPDATED_PAYMENT_DATE);
        assertThat(testRequirement.getAcceptedDeliveryDate()).isEqualTo(UPDATED_ACCEPTED_DELIVERY_DATE);
