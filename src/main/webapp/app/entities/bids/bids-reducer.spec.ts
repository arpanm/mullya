...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bids.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BIDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BIDS actions', async () => {
      const expectedActions = [
        {
