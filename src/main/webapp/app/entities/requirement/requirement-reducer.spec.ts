...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUIREMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUIREMENT actions', async () => {
      const expectedActions = [
        {
