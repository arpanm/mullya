...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hub.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HUB_LIST actions', async () => {
    ...
    it('dispatches FETCH_HUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HUB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HUB actions', async () => {
      const expectedActions = [
        {
