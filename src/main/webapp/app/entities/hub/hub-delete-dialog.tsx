...
export const HubDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(hubEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-hub" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
