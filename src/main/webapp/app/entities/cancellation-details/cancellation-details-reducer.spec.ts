...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cancellation-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANCELLATIONDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CANCELLATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CANCELLATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CANCELLATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CANCELLATIONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CANCELLATIONDETAILS actions', async () => {
      const expectedActions = [
        {
