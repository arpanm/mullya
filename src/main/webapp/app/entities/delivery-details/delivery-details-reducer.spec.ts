...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERYDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DELIVERYDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DELIVERYDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DELIVERYDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERYDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DELIVERYDETAILS actions', async () => {
      const expectedActions = [
        {
