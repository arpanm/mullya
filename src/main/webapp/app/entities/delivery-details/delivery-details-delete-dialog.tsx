...
export const DeliveryDetailsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="mulyaaApp.deliveryDetails.delete.question">
        <Translate contentKey="mulyaaApp.deliveryDetails.delete.question" interpolate={{ id: deliveryDetailsEntity.id }}>
