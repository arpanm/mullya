...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './remittance-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMITTANCEDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REMITTANCEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REMITTANCEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REMITTANCEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REMITTANCEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REMITTANCEDETAILS actions', async () => {
      const expectedActions = [
        {
