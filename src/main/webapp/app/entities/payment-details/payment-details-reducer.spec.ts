...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAYMENTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTDETAILS actions', async () => {
      const expectedActions = [
        {
