...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIDDINGDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BIDDINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BIDDINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BIDDINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BIDDINGDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BIDDINGDETAILS actions', async () => {
      const expectedActions = [
        {
