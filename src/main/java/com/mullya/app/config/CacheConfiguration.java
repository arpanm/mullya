...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mullya.app.domain.User.class.getName() + ".requirements");
            createCache(cm, com.mullya.app.domain.User.class.getName() + ".oTPS");
            createCache(cm, com.mullya.app.domain.User.class.getName() + ".addresses");
            createCache(cm, com.mullya.app.domain.User.class.getName() + ".stocks");
            createCache(cm, com.mullya.app.domain.User.class.getName() + ".bids");
            createCache(cm, com.mullya.app.domain.User.class.getName() + ".orders");
            createCache(cm, com.mullya.app.domain.User.class.getName() + ".remittanceDetails");
