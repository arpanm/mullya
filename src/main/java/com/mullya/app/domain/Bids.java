...
public class Bids implements Serializable {
    ...
    public Bids createdOn(LocalDate createdOn) {
    ...
    public Bids createdBy(String createdBy) {
    ...
    public Bids updatedOn(LocalDate updatedOn) {
    ...
    public Bids updatedBy(String updatedBy) {
