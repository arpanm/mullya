...
/**
 * REST controller for managing {@link com.mullya.app.domain.DeliveryDetails}.
 */
@RestController
@RequestMapping("/api")
public class DeliveryDetailsResource {
    ...
    private static final String ENTITY_NAME = "deliveryDetails";
    ...
    public ResponseEntity<DeliveryDetailsDTO> createDeliveryDetails(@Valid @RequestBody DeliveryDetailsDTO deliveryDetailsDTO)
    ...
    public ResponseEntity<DeliveryDetailsDTO> updateDeliveryDetails(
        ...
        @Valid @RequestBody DeliveryDetailsDTO deliveryDetailsDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<DeliveryDetailsDTO> partialUpdateDeliveryDetails(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody DeliveryDetailsDTO deliveryDetailsDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<List<DeliveryDetailsDTO>> getAllDeliveryDetails(Pageable pageable) {
        log.debug("REST request to get a page of DeliveryDetails");
        Page<DeliveryDetailsDTO> page = deliveryDetailsService.findAll(pageable);
