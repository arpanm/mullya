...
public class UserService {
    ...
    public void removeNotActivatedUsers() {
        userRepository
            .findAllByActivatedIsFalseAndActivationKeyIsNotNullAndCreatedOnBefore(Instant.now().minus(3, ChronoUnit.DAYS))
            .forEach(user -> {
